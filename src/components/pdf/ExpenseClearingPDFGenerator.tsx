        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 9px;">
          ...
          <tbody>
            ...
            <tr style="background: #e6f3ff; font-weight: bold; height: 32px;">
              ...
              <td style="border: 1px solid black; padding: 6px; text-align: right; vertical-align: middle; color: blue; height: 32px;">
                ${formatCurrency(totalRequested)}
              </td>
              <td style="border: 1px solid black; padding: 6px; text-align: right; vertical-align: middle; color: orange; height: 32px;">
              ...
              <td style="border: 1px solid black; padding: 6px; text-align: right; vertical-align: middle; color: ${totalRefund >= 0 ? 'green' : 'red'}; font-size: 11px; height: 32px;">
