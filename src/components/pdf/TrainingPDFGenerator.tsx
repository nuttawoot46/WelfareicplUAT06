    ...
    ">
      <div style="border: 2px solid #000000; padding: 8mm; height: calc(100% - 16mm); background: #ffffff; display: flex; flex-direction: column;">
        ...
        <div style="display: flex; align-items: flex-start; margin-bottom: 10px; position: relative;">
          <!-- Logo Section -->
          <div style="width: 60px; height: 45px; border: 2px solid #000; display: flex; align-items: center; justify-content: center; margin-right: 10px;">
            ${logoBase64 ? `
              <img src="${logoBase64}" 
                   alt="Logo" 
                   style="max-width: 55px; max-height: 40px; object-fit: contain;" />
            ` : `
              <div style="text-align: center; font-size: 8pt; color: #000; font-weight: bold;">
                ICP
              </div>
            `}
          </div>
          ...
          <div style="text-align: right; font-size: 8pt; color: #000; width: 100px;">
            ...
            <div style="display: flex; align-items: center; justify-content: flex-end; font-size: 7pt;">
              <div style="border: 1px solid #000; padding: 1px 2px; margin-right: 1px; font-size: 6pt;">ต้นสังกัด</div>
              <div style="margin: 0 1px;">→</div>
              <div style="border: 1px solid #000; padding: 1px 2px; margin-right: 1px; font-size: 6pt;">HR</div>
              <div style="margin: 0 1px;">→</div>
              <div style="border: 1px solid #000; padding: 1px 2px; font-size: 6pt;">VP</div>
            </div>
          </div>
        </div>
        ...
        <div style="margin-bottom: 12px; font-size: 9pt; line-height: 1.3; color: #000;">
          ...
          <div style="margin-bottom: 5px; text-indent: 30px;">
            เนื่องด้วยข้าพเจ้า นาย/นาง/นางสาว.........${employeeName}......
          </div>
          <div style="margin-bottom: 5px;">
            มีความประสงค์จะเข้ารับการอบรม
          </div>
          <div style="margin-bottom: 5px;">
        ...
        <div style="margin-bottom: 12px; font-size: 9pt; color: #000;">
          ...
          <div style="margin-bottom: 4px;">
            1. .....................................${objectives[0] || 'เพิ่มพูนความรู้และทักษะในการปฏิบัติงาน'}.....................................
          </div>
          <div style="margin-bottom: 8px;">
            2. .....................................${objectives[1] || 'พัฒนาประสิทธิภาพและคุณภาพการทำงาน'}.....................................
          </div>
        </div>
        ...
        <div style="margin-bottom: 8px; font-size: 9pt; color: #000;">
          <div style="margin-bottom: 5px;">
            ทั้งนี้ค่าใช้จ่ายในการอบรม ในวงเงิน ...................${financials.totalAmount.toLocaleString('th-TH', { minimumFractionDigits: 2 })}................... บาท และคงเหลือค่าอบรมจำนวน .....${remainingBudgetAmount.toLocaleString('th-TH', { minimumFractionDigits: 2 })}.....บาท โดย
          </div>
          <div style="margin-bottom: 5px;">
        ...
        <!-- Financial Table -->
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 8px; font-size: 9pt; color: #000;">
          <tr>
            <td style="border: 2px solid #000; padding: 4px; text-align: left; font-weight: normal;">
              ค่าใช้จ่ายค่าอบรมหลักสูตร (ยกเว้น Vat)
            </td>
            <td style="border: 2px solid #000; padding: 4px; text-align: right; font-weight: normal;">
              ${financials.baseCost.toLocaleString('th-TH', { minimumFractionDigits: 2 })} บาท 
            </td>
          </tr>
          <tr>
            <td style="border: 2px solid #000; padding: 4px; text-align: left; font-weight: normal;">
            ...
            <td style="border: 2px solid #000; padding: 4px; text-align: right; font-weight: normal;">
              ${financials.vatAmount.toLocaleString('th-TH', { minimumFractionDigits: 2 })} บาท 
            </td>
          </tr>
          <tr>
            <td style="border: 2px solid #000; padding: 4px; text-align: left; font-weight: normal;">
              หัก ภาษี ณ ที่จ่าย 3% (3.00%)
            </td>
            <td style="border: 2px solid #000; padding: 4px; text-align: right; font-weight: normal;">
              ${financials.withholdingTax.toLocaleString('th-TH', { minimumFractionDigits: 2 })} บาท 
            </td>
          </tr>
          <tr>
            <td style="border: 2px solid #000; padding: 4px; text-align: left; font-weight: bold;">
              ยอดสุทธิ (ส.ป.)
            </td>
            <td style="border: 2px solid #000; padding: 4px; text-align: right; font-weight: bold;">
              ${financials.netAmount.toLocaleString('th-TH', { minimumFractionDigits: 2 })} บาท 
            </td>
          </tr>
          <tr>
            <td style="border: 2px solid #000; padding: 4px; text-align: left; font-weight: normal;">
          ...
          <tr>
            <td style="border: 2px solid #000; padding: 6px; text-align: center; font-weight: bold;" colspan="2">
              จำนวนเงิน ${financials.netAmountText}
            </td>
          </tr>
        </table>
              ...
              <td style="border: 2px solid #000; padding: 8px; width: 50%; vertical-align: top;">
                <div style="text-align: center; margin-bottom: 8px;">
                  <div style="display: flex; align-items: center; justify-content: center; margin-bottom: 5px;">
                    ...
                    <span style="border: 2px solid #000; width: 14px; height: 14px; display: inline-block; margin-right: 12px; position: relative; background: #fff;">
                      ${userSignature ? '<span style="position: absolute; top: -1px; left: 3px; font-size: 9px; font-weight: bold; color: #000;">✓</span>' : ''}
                    </span>
              ...
              <td style="border: 2px solid #000; padding: 8px; width: 50%; vertical-align: top;">
                <div style="text-align: center; margin-bottom: 8px;">
                  <div style="display: flex; align-items: center; justify-content: center; margin-bottom: 5px;">
                    <span style="margin-right: 8px;">อนุมัติ</span>
                    <span style="border: 2px solid #000; width: 14px; height: 14px; display: inline-block; margin-right: 12px; position: relative; background: #fff;">
                      ${managerSignature ? '<span style="position: absolute; top: -1px; left: 3px; font-size: 12px; font-weight: bold; color: #000;">✓</span>' : ''}
                    </span>
                    <span style="margin-right: 8px;">ไม่อนุมัติ</span>
                    <span style="border: 2px solid #000; width: 14px; height: 14px; display: inline-block; background: #fff;"></span>
                  </div>
                ...
                <div style="text-align: center; margin-bottom: 15px;">
                  <div style="display: flex; align-items: flex-end; justify-content: center;">
                    ...
                    `}
                    <span style="margin-left: 5px; font-size: 8pt;">ผู้จัดการบริษัท</span>
                  </div>
                  ${managerSignature ? `
                    <div style="text-align: center; margin-top: 3px;">
                      <span style="font-size: 8px;">(${managerName})</span>
                    </div>
                  ` : ''}
                </div>
                <div style="text-align: center; font-size: 8pt;">
            ...
            <tr>
              ...
              <td style="border: 2px solid #000; padding: 8px; vertical-align: top;">
                <div style="text-align: center; margin-bottom: 8px;">
                  <div style="display: flex; align-items: center; justify-content: center; margin-bottom: 5px;">
                    <span style="margin-right: 8px;">อนุมัติ</span>
                    <span style="border: 2px solid #000; width: 14px; height: 14px; display: inline-block; margin-right: 12px; position: relative; background: #fff;">
                      ${hrSignature ? '<span style="position: absolute; top: -1px; left: 3px; font-size: 12px; font-weight: bold; color: #000;">✓</span>' : ''}
                    </span>
                    <span style="margin-right: 8px;">ไม่อนุมัติ</span>
                    <span style="border: 2px solid #000; width: 14px; height: 14px; display: inline-block; background: #fff;"></span>
                  </div>
              ...
              <td style="border: 2px solid #000; padding: 8px; vertical-align: top;">
                <div style="text-align: center; margin-bottom: 8px;">
                  <div style="display: flex; align-items: center; justify-content: center; margin-bottom: 5px;">
                    <span style="margin-right: 8px;">อนุมัติ</span>
                    <span style="border: 2px solid #000; width: 14px; height: 14px; display: inline-block; margin-right: 12px; background: #fff;"></span>
                    <span style="margin-right: 8px;">ไม่อนุมัติ</span>
                    <span style="border: 2px solid #000; width: 14px; height: 14px; display: inline-block; background: #fff;"></span>
                  </div>
                </div>
