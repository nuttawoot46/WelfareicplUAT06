...
export const getBenefitLimits = async (): Promise<BenefitLimit[]> => {
  ...
  try {
    ...
    // สวัสดิการค่าตัดแว่นสายตาและค่ารักษาทันตกรรม (รวมกัน)
    if (employee.budget_dentalglasses !== null && employee.budget_dentalglasses !== undefined) {
      const totalLimit = 2000; // วงเงินทั้งหมด (รวมค่าแว่นและค่ารักษาทันตกรรม)
    ...
    return [
      ...
      // รวมค่าตัดแว่นสายตาและค่ารักษาทันตกรรมเป็นรายการเดียวกัน
